...
type UserProjectItemRouteProps = {
  params: Promise<{ owner: string; number: string; itemId: string }>;
...
export default async function UserProjectItemRoute({
  params,
  searchParams,
}: UserProjectItemRouteProps) {
  const [{ owner, number, itemId }, queryParams, { session, shellContext }] =
