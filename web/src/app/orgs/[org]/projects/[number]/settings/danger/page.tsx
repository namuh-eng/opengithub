...
type OrganizationProjectDangerSettingsRouteProps = {
  params: Promise<{ org: string; number: string }>;
};

export default async function OrganizationProjectDangerSettingsRoute({
  params,
}: OrganizationProjectDangerSettingsRouteProps) {
  ...
  const result = Number.isFinite(projectNumber)
    ...
    : {
        ...
        status: 404,
        code: "not_found",
        message: "Project danger settings could not be found.",
      };
      ...
      {result.ok ? (
        ...
        <main className="mx-auto max-w-[760px] px-6 py-16">
          <div className="card p-6">
            <div className="t-label mb-2">Project danger zone unavailable</div>
            <h1 className="t-h2">
              This project lifecycle cannot be configured.
            </h1>
