...
test("signed-in repository milestones manage lifecycle, assignment, reorder, and mobile layout", async ({
  ...
  await page.reload();
  await expect(page.locator(".chip.ok", { hasText: "closed" })).toBeVisible();
  await page.getByRole("button", { name: "Reopen" }).click();
  await page.reload();
  await expect(page.locator(".chip.soft", { hasText: "open" })).toBeVisible();
  ...
  await page
    ...
    .click();
  await page.getByLabel("Filter milestones").fill("No milestone");
